...
unzip("./data/household_power_consumption.zip", files = NULL, list = FALSE, overwrite = TRUE, junkpaths = FALSE, 
...
df <- read.csv.sql("./data/household_power_consumption.txt", sql = " select * from file where Date='1/2/2007' or 
...
###character variable describing Date-Time to a date-time format
